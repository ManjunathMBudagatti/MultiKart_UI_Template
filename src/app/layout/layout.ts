        ...
        if (event instanceof NavigationEnd) {
          if (this.theme) {
            ...
            if (
              ...
              this.theme == 'furniture_one' ||
              this.theme == 'furniture_two' ||
              this.theme == 'furniture_dark' ||
              this.theme == 'jewellery_two' ||
              this.theme == 'jewellery_three'
            ) {
              ...
              this.theme == 'vegetables_two' ||
              this.theme == 'vegetables_three' ||
              this.theme == 'nursery'
            ) {
          ...
          if (
            ...
            (this.theme == 'marketplace_two' ||
              this.theme == 'marketplace_four' ||
              this.theme == 'marijuana' ||
              this.theme == 'vegetables_four' ||
              this.theme == 'gym' ||
              this.theme == 'gradient' ||
