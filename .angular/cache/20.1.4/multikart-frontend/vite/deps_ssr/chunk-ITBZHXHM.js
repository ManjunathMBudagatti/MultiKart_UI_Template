...
var LoadingBarState = class {
  constructor(config = {}) {
    ...
    this.requests = null;
    this.disabled = false;
    this.stream$ = new import_rxjs.Subject();
    this._value$ = null;
    this.timer$ = (s) => {
      let state$ = (0, import_rxjs.of)(s);
      switch (s.action) {
        case "start":
        case "increment":
        case "set": {
          ...
          if (this.requests > 0) {
            state$ = (0, import_rxjs.timer)(this.config.latencyThreshold, 250).pipe((0, import_operators.map)((t) => __spreadProps(__spreadValues({}, s), {
        ...
        case "complete":
        case "stop": {
          state$ = s.value === 0 ? (0, import_rxjs.of)(__spreadValues({}, s)) : (0, import_rxjs.timer)(0, 500).pipe((0, import_operators.take)(2), (0, import_operators.map)((t) => ({
            value: t === 0 ? 100 : 0
          })));
          break;
        }
      }
      return state$.pipe((0, import_operators.map)((next) => __spreadProps(__spreadValues({}, next), {
        action: "set"
      })), (0, import_operators.tap)((next) => this.next(next, false)));
    };
  ...
  get value$() {
    ...
    return this._value$ = this.stream$.pipe((0, import_operators.startWith)(this.state), (0, import_operators.switchMap)((s) => this.timer$(s)), (0, import_operators.shareReplay)(), (0, import_operators.map)((s) => s.value));
  }
...
var _LoadingBarService = class _LoadingBarService {
  ...
  constructor(platformId, config = {}, zone) {
    ...
    this.zone = zone;
    this.refs = {};
    this.streams$ = new import_rxjs.Subject();
    this.value$ = this.streams$.pipe((0, import_operators.startWith)(null), (0, import_operators.switchMap)(() => (0, import_rxjs.combineLatest)(Object.keys(this.refs).map((s) => this.refs[s].value$))), runInZone(this.zone), (0, import_operators.map)((v) => Math.max(0, ...v)));
  }
...
function runInZone(zone) {
  ...
  return (source) => new import_rxjs.Observable((observer) => source.subscribe((value) => zone.run(() => observer.next(value)), (e) => zone.run(() => observer.error(e)), () => zone.run(() => observer.complete())));
}
var _NgxLoadingBar = class _NgxLoadingBar {
  get value$() {
...
_NgxLoadingBar.ɵfac = function NgxLoadingBar_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgxLoadingBar)(ɵɵdirectiveInject(LoadingBarService));
};
_NgxLoadingBar.ɵcmp = ɵɵdefineComponent({
  type: _NgxLoadingBar,
...
var NgxLoadingBar = _NgxLoadingBar;
(() => {
...
var _LoadingBarComponent = class _LoadingBarComponent extends NgxLoadingBar {
};
_LoadingBarComponent.ɵfac = /* @__PURE__ */ (() => {
...
_LoadingBarComponent.ɵcmp = ɵɵdefineComponent({
...
var LoadingBarComponent = _LoadingBarComponent;
(() => {
...
var _LoadingBarModule = class _LoadingBarModule {
};
_LoadingBarModule.ɵfac = function LoadingBarModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _LoadingBarModule)();
};
_LoadingBarModule.ɵmod = ɵɵdefineNgModule({
  type: _LoadingBarModule,
  declarations: [LoadingBarComponent],
  imports: [CommonModule],
  exports: [LoadingBarComponent]
});
_LoadingBarModule.ɵinj = ɵɵdefineInjector({
  imports: [CommonModule]
});
var LoadingBarModule = _LoadingBarModule;
(() => {
...
//# sourceMappingURL=chunk-ITBZHXHM.js.map
